...
class FourierDiffusion(TSDiffBase):
    def __init__(
        self,
        backbone_parameters,
        timesteps,
        ...
        # Ensure attributes expected by training scripts are present
        self.time_features = getattr(self, "time_features", [])
        self.lags_seq = getattr(self, "lags_seq", [0])
